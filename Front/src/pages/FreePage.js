...
const FreePage = () => {
    const [posts, setPosts] = useState([]); // 전체 자유게시판 게시물 목록
        ...
        const fetchPosts = async () => {
            ...
            try {
                const response = await api.get('/posts', {
                    params: {
                        mainCategories: ['커뮤니티'], // 메인 카테고리를 '커뮤니티'로 고정
                        smallCategories: ['자유게시판'], // 소카테고리를 '자유게시판'으로 고정
    ...
    return (
        <div className="informationboard-container">
            ...
            {/* 배너 */}
            <Banner src={banner1} title="🗽자유게시판"/>
