...
import banner1 from '../image/RecommendationBoardbanner.jpg';
...
const Recommendedboard = () => {
    const [posts, setPosts] = useState([]); // 전체 추천 게시물 목록
        ...
        const fetchPosts = async () => {
            ...
            try {
                const response = await api.get('/posts', {
                    params: {
                        mainCategories: ['추천'], // 메인 카테고리를 '추천'으로 설정
    ...
    return (
        <div className="informationboard-container">
            ...
            {/* 배너 */}
            <Banner src={banner1} title="👍 추천 게시판" />
